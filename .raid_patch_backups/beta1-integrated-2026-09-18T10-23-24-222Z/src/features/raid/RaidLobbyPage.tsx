...
function RaidLobbyAvatar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative flex h-[142px] w-[106px] items-end justify-center rounded-[42%_42%_18%_18%] border bg-black/15 px-1 pt-2 transition',
          isMe
      ...
      >
        {player.equipped_character_image_url ? (
          <img
            ...
            className="h-[134px] w-[98px] object-contain drop-shadow-[0_12px_12px_rgba(0,0,0,0.68)]"
            draggable={false}
          />
        ) : (
