-- B.R.A.N.D 2.0 RAID V1 Phase D archived-result compatibility
-- Production migration version: 20260915041442 (already applied).
...
GRANT EXECUTE ON FUNCTION public.get_raid_battle_state(BIGINT) TO authenticated, service_role;
