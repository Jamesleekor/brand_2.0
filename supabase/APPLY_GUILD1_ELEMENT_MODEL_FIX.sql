...
-- NOTE: p_element keeps DEFAULT NULL for CREATE OR REPLACE compatibility with the existing G1 function.
-- The body still rejects NULL/blank, so new UI flows must explicitly provide an element.
